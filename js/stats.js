...
const eventsStats = document.getElementById('estadisticasEvento');
...
const upcomingStats = document.getElementById('statsUpcoming');
const pastStats = document.getElementById('statsPasadas');
